class Swctl < Formula
  ...
  url "https://github.com/nguyenytran/swctl/releases/download/v0.6.19/swctl-0.6.19.tar.gz"
  sha256 "7e893587564c2b1e3dfcc5fadf9cd60eb77ea07767bf21ff9b83247372600ad4"
  license "MIT"
