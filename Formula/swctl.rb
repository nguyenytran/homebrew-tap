class Swctl < Formula
  ...
  url "https://github.com/nguyenytran/swctl/releases/download/v0.7.5/swctl-0.7.5.tar.gz"
  sha256 "6e709d31856ced977a945a1cbb9a613796750981fcb6cb23852b7a61faf4d88b"
  license "MIT"
